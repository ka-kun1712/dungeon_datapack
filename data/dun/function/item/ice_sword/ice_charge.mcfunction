...
execute as @e[type=!#dun:ignore_damage] at @s if entity @e[type=armor_stand,tag=summon_ice,distance=..2] run damage @s 5
execute as @e[type=!#dun:ignore_damage,tag=boss] at @s if entity @e[type=armor_stand,tag=summon_ice,distance=..3] run damage @s 2
