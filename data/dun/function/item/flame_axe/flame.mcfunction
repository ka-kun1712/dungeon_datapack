...
execute as @e[type=!player,type=!item,type=!armor_stand] at @s if entity @e[type=armor_stand, tag= flame,distance=..3] run damage @s 10
execute as @e[type=!player,type=!item,type=!armor_stand] at @s if entity @e[type=armor_stand, tag= flame,distance=..3] run data merge entity @s {Fire:100s}
